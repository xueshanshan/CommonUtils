...
public class AnimZoomRelativeLayout extends RelativeLayout implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public AnimZoomRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimZoomRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AnimZoomRelativeLayout);
        float zoomScale = typedArray.getFloat(R.styleable.AnimZoomRelativeLayout_zoom_scale, 0.96f);
        int downDuration = typedArray.getInt(R.styleable.AnimZoomRelativeLayout_duration_down, 200);
        int upDuration = typedArray.getInt(R.styleable.AnimZoomRelativeLayout_duration_up, 100);
        typedArray.recycle();
